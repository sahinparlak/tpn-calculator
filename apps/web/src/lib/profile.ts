...
/**
 * Guideline-traceable dosing summary shown on the builtin's detail screen. Mirrors
 * `profiles/espghan-2018-reference.sources.md`; values are display-only.
 */
...
/**
 * A dosing summary derived directly from any profile's own values. Display-only;
 * used by the profile detail view to give every profile a readable overview.
 */
